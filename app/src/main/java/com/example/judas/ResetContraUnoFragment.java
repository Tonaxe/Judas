...
public class ResetContraUnoFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_reset_contra_uno, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageArrowleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_resetContraUnoFragment_to_logInFragment);
            }
        });
        ...
        // Obtener referencia a la imagen
        View btnEnviar = view.findViewById(R.id.btnEnviar);
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Navegar al fragmento LogRegInicioFragment utilizando la acción definida en nav_graph.xml
                navController.navigate(R.id.action_resetContraUnoFragment_to_resetContraDosFragment);
            }
        });
    }
}